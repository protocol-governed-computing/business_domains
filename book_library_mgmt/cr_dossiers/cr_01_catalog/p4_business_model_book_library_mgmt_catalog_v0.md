# Business Model — book_library_mgmt / catalog
...
| Register a book | S3 authoring_decisions Register a book | CRITICAL | GAP-01 | |
...
| catalog | capability_side_effects::CS_APPENDONLY_JSONL_V0 | capability call | SATISFIED | S3 authoring_decisions Append a durable record |
...
| GAP-04 | S3 authoring_decisions Retire an obsolete record | Retire an obsolete record | catalog | Author this CR |
