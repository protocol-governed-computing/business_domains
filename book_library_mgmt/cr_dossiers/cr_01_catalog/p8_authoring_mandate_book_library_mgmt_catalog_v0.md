...
|------|------|------|-------------------------------|-----------|------------|
| 1 | 1 | catalog::STRUCTURE_CATALOG_STORAGE_V0 | NEW | catalog | — |
...
| 2 | 7 | catalog::CC_UPDATE_BIBLIOGRAPHIC_INFORMATION_V0 | NEW | catalog | catalog::STRUCTURE_CATALOG_STORAGE_V0 |
...
| 3 | catalog::RB_CATALOG_BINDINGS_V0 |
