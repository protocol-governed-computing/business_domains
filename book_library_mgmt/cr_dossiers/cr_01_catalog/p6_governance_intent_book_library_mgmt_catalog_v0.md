...
| Declare the stores this subdomain owns | catalog | OWNED | | S5 scope_boundary Declare the stores |
...
| Declare the stores this subdomain owns | catalog | S6 ownership Declare the stores this subdomain owns |
