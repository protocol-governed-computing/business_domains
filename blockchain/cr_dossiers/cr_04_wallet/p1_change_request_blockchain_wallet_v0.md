...
|-----------|----------------|-----------|--------------|
| wallet | NEW_SUBDOMAIN | Wallet does not exist. An accepted person currently holds nothing, has no address anyone could pay, and owns nothing the business can point to. | CR seed §1 CR Type #1 |
